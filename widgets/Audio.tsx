...
export function AudioControl({
  ...
  const triggerTooltip = createComputed(() => {
    ...
    const status = muted() ? `Sound muted • ${value}%` : `Sound ${value}%`
    return status
  })
  ...
  return (
    ...
    >
      ...
      <button class="icon-button quick-toggle flat" valign={Gtk.Align.CENTER} tooltipText={triggerTooltip} onClicked={onToggle}>
